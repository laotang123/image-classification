...
trainset = ListDataset(root='/search/odin/liukuang/data/voc_all_images',
                       list_file='D:/code/pytorch-retinanet-master/data/voc12_train.txt', train=True, transform=transform, input_size=600)
...
testset = ListDataset(root='/search/odin/liukuang/data/voc_all_images',
                      list_file='D:/code/pytorch-retinanet-master/data/voc12_val.txt', train=False, transform=transform, input_size=600)
