...
def WriteResnet14(write_path):
    ...
    with open(write_path, "w") as file:
        json.dump(json_dict, file, indent=4, separators=(',', ': '))
def WriteDenseResnetBase(write_path):
    """
    ['conv1', 'bn1',
    ...
    with open(write_path, "w") as file:
        json.dump(json_dict, file, indent=4, separators=(',', ': '))
def WriteDenseResnetV1(write_path):
    """
    :param write_path:
    :return:
    """
...
def WriteDenseResnetV3(write_path):
    """
    ['conv1', 'bn1',
...
if __name__ == "__main__":
    ...
    # WriteDenseResnetBase("json/dense_resnet_base.json")
    # WriteDenseResnetV1("json/dense_resnet_v1.json")
    WriteDenseResnetV3("json/dense_resnet_v3.json")
